...
function applyStyleSheet() {
  const stylesheet = isLightMode
    ? `${staticURL}/static/css/light.css`
    : `${staticURL}/static/css/dark.css`;
...
$(document).ready(function () {
  $("ul.theme-colors li").click(function () {
    ...
    if (id === "1") {
      skinColor.setAttribute(
        "href",
        `${staticURL}/static/css/skins/color-1.css`
      );
      ...
      skinColor.setAttribute(
        "href",
        `${staticURL}/static/css/skins/color-2.css`
      );
      localStorage.setItem(
        "color-style",
        `${staticURL}/static/css/skins/color-2.css`
      ...
      skinColor.setAttribute(
        "href",
        `${staticURL}/static/css/skins/color-3.css`
      );
      localStorage.setItem(
        "color-style",
        `${staticURL}/static/css/skins/color-3.css`
      ...
      skinColor.setAttribute(
        "href",
        `${staticURL}/static/css/skins/color-4.css`
      );
      localStorage.setItem(
        "color-style",
        `${staticURL}/static/css/skins/color-4.css`
      ...
      skinColor.setAttribute(
        "href",
        `${staticURL}/static/css/skins/color-5.css`
      );
      localStorage.setItem(
        "color-style",
        `${staticURL}/static/css/skins/color-5.css`
